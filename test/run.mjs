...
// real ~/.plothole/ state, mirroring CI exactly. Set PLOTHOLE_TEST_REAL_HOME=1 to opt out.
//
...
const sandboxHome = process.env.PLOTHOLE_TEST_REAL_HOME
  ? null
  : mkdtempSync(join(tmpdir(), "plothole-test-home-"));
